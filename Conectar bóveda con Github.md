...
5. Crea en obsidian una carpeta para almacenar el repositorio (por ejemplo, `remote-blog/`). Y dejar vacío el directorio.![https://github.com/Tony-Sec/OBSIDIAN/blob/main/img/remote-blog.png](remote-blog.png)
